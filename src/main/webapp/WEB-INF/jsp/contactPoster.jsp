...
<div class="row">
  <div class="col-xs-12">
    <div class="section-container-spacer">
      <h1>Inquire</h1>
      <p>Contact the "enter posters name" about this post</p>
    </div>
    <div class="section-container-spacer">
       <form action="contactPoster" class="reveal-content">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
              <img alt="" src="./images/ps4pic.jpeg" width="300px" height="200px">
              <h1>"Enter Posters Name"</h1>
              <h2>PS4</h2>
              <h4>Description:</h4>
            ...
            <div class="col-md-6">
              ...
              <a href="https://pinterest.com/" title="" class="fa-icon">
