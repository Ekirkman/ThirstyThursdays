    ...
    <div class="section-container-spacer">
          ...
          <div class="row">
            ...
            <img alt="" src="data:image/jpg;base64,${post.showPicture()}" width="300px" height="200px" >
                <form method="POST" action="/updatePic" enctype="multipart/form-data">
    <input  type="file" name="file" /><br>
    <div><input type="submit" class="btn btn-success" value="updatePic" /></div>
    
</form>
             <form:form action="/postUpdate" method="POST" class="reveal-content" modelAttribute="post">
