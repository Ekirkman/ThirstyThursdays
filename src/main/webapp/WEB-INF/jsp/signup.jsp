...
<div class="row">
  <div class="col-xs-12">
    <div class="section-container-spacer">
      ...
      <p>Start buying, selling, and trading</p>
    </div>
    <div class="section-container-spacer">
       
          <div class="row">
          <form:form action="/signUp" method="POST" class="reveal-content" modelAttribute="user" >
            <div class="col-md-6">
              <div class="form-group">
                <form:input type="email" class="form-control" path="email" placeholder="Email" required="required"></form:input>
              </div>
              <div class="form-group">
 				 <form:input type="text" class="form-control" path="userName" placeholder="Username" required="required"></form:input>
              </div>
              <div class="form-group">
                <form:input type="password" class="form-control" path="password" placeholder="Password" required="required"></form:input>
              </div>
              <button type="submit" class="btn btn-primary btn-lg">Join in</button>
            </div>
            </form:form>
            <div class="col-md-6">
